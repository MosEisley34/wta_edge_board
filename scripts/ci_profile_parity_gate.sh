...
PROFILE_SUMMARY_RUN_ID="${PROFILE_SUMMARY_RUN_ID:-$(date -u +%Y-%m-%dT%H-%M-%SZ)}"
PROFILE_SUMMARY_JSON_OUT="${PROFILE_SUMMARY_JSON_OUT:-$ROOT_DIR/docs/baselines/pipeline_log_profile_ci_summary_${PROFILE_SUMMARY_RUN_ID}.json}"
