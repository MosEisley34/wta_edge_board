...
function appendLogRow_(entry) {
  ...
  sh.appendRow([
    ...
    normalized.no_hit_no_events_from_source_count === null || normalized.no_hit_no_events_from_source_count === undefined ? '' : normalized.no_hit_no_events_from_source_count,
    normalized.no_hit_events_outside_time_window_count === null || normalized.no_hit_events_outside_time_window_count === undefined ? '' : normalized.no_hit_events_outside_time_window_count,
    normalized.no_hit_tournament_filter_excluded_count === null || normalized.no_hit_tournament_filter_excluded_count === undefined ? '' : normalized.no_hit_tournament_filter_excluded_count,
