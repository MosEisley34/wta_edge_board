...
- Comparison command: `python3 scripts/compare_log_profiles.py docs/baselines/pipeline_log_sample_3h_verbose_2026-03-12_fix.json docs/baselines/pipeline_log_sample_3h_compact_2026-03-12_fix.json --summary-json-out docs/baselines/pipeline_log_profile_comparison_2026-03-12_fix.json`
...
- Sample size bytes changed from **345,493** to **351,901** for both verbose/compact on this rerun window; this does **not** change rollout readiness because percentage reduction remains **0.00%**.
